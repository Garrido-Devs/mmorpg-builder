...
export const COMPONENT_DEFINITIONS: Record<ComponentType, ComponentDefinition> = {
  ...
  collider: {
    ...
    properties: [
      ...
      { name: 'É Trigger', key: 'isTrigger', type: 'boolean', default: false, group: 'Configuração' },
      { name: 'Tamanho', key: 'size', type: 'vector3', default: { x: 1, y: 1, z: 1 }, group: 'Dimensões' },
      { name: 'Offset', key: 'offset', type: 'vector3', default: { x: 0, y: 0, z: 0 }, group: 'Dimensões' },
      { name: 'Layer', key: 'layer', type: 'string', default: 'default', group: 'Colisão' },
    ],
  },
